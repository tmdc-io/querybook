...
export const UserMenuHeader: React.FC<IUserMenuProps> = ({
    tooltipPos = 'left',
    popoverLayout = ['bottom', 'right'] as PopoverLayout,
}) => {
    ...
    const getUserDropdownDOM = () => {
        ...
        return (
            <Menu>
                <MenuInfoItem>
                    <UserBadge uid={userInfo.uid} cardStyle header />
                </MenuInfoItem>
                <MenuDivider />
                {themeToggle}
    ...
    return (
        <>
            ...
            >
                <UserBadge mini uid={userInfo.uid} cardStyle header />
            </span>
